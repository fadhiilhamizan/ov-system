...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      { id: "Violet hanya membaca data Ormawa Visit yang sedang kamu buka di pemilih edisi. Kalau yang kamu tanyakan ada di edisi lain, ganti dulu edisinya lewat pemilih di bar atas.", en: "Violet only reads the Ormawa Visit currently selected in the edition switcher. If what you are asking about belongs to another edition, switch to it first using the picker in the top bar." },
