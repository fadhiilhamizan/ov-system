...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      { id: "Menghapus tautan semacam itu dari Super Link mencabut centang 'Tampilkan juga di Super Link' di sumbernya; tautannya sendiri tetap ada di tugas atau prospeknya.", en: "Deleting such a link from Super Link unticks 'Also show in Super Link' at its source; the link itself stays on the task or prospect." },
      { id: "Tugas yang memakai tautan Super Link sebagai referensi selalu mengikuti URL terbarunya, jadi memperbaiki alamat di sini langsung memperbaiki semua tugas yang merujuknya.", en: "Tasks that use a Super Link entry as a reference always follow its current URL, so fixing an address here fixes every task that refers to it." },
