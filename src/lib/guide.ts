...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "Anggota juga bisa ditambahkan langsung dari kartu divisinya: tombol 'Tambah anggota' di bagian Struktur Tim, dengan divisi tersebut sudah tercentang otomatis — tidak perlu pindah ke tab Anggota EA dan mencarinya di daftar.", en: "A member can also be added straight from their division card: the 'Add member' button in the Team Structure block, with that division already ticked — no need to switch to the EA Members tab and find it in the list." },
