...
export const EN: Record<string, string> = {
  ...
  // v1.50.0 - akun bersama, ubah info akun, foto profil karakter.
  "Ubah Informasi Akun": "Edit Account Details",
  "Nama dan foto profil ini yang dilihat anggota lain di seluruh sistem.": "This name and picture are what everyone else sees across the system.",
  "Nama tampilan": "Display name",
  "Foto profil": "Profile picture",
  "Pakai inisial nama": "Use your initials",
  "Pilihan paling kiri memakai inisial namamu.": "The leftmost option uses your initials.",
  "Email dan peran tidak bisa diubah dari sini. Peran diberikan admin lewat Role Request.": "Email and role cannot be changed here. An admin grants your role through Role Request.",
  "Informasi akun diperbarui": "Account details updated",
  "Ubah": "Edit",
  "Akun bersama": "Shared account",
  "Akun bersama: kata sandinya tidak bisa diubah dari sini.": "Shared account: its password cannot be changed here.",
  "Akun ini dipakai bersama, jadi perubahan nama dan foto profilnya terlihat oleh semua orang yang memakainya.": "This account is shared, so a change to its name or picture is visible to everyone who uses it.",
  "Akun ini dipakai bersama banyak orang, jadi kata sandinya tidak bisa diubah dari dalam aplikasi. Hubungi admin kalau kata sandinya perlu diganti.": "This account is shared by many people, so its password cannot be changed from inside the app. Ask an admin if it needs rotating.",
  // Nama karakter foto profil (CHARACTER_LABEL, dilewatkan t() secara dinamis).
  "Rubah": "Fox",
  "Panda": "Panda",
  "Burung": "Bird",
  "Kucing": "Cat",
  "Beruang": "Bear",
  // v1.52.0 - evaluasi tugas, hasil tugas wajib terbit, referensi Super Link.
  "Cari nama, divisi, atau Ormawa Visit…": "Search by name, division or Ormawa Visit…",
  "Catatan penting atau konteks tugas": "Important notes or context for this task",
  "Dirujuk oleh": "Referenced by",
  "Evaluasi": "Evaluation",
  "Evaluasi tugas ini dari Ormawa Visit sebelumnya dan/atau Ormawa Visit sekarang": "Evaluation of this task from the previous and/or the current Ormawa Visit",
  "Ganti": "Replace",
  "Hapus lewat tugasnya di Work Breakdown": "Delete it from its task in Work Breakdown",
  "Ikut tersalin saat tugas disalin ke Ormawa Visit berikutnya, jadi pelajarannya tidak hilang.": "Copied along when the task is copied to the next Ormawa Visit, so the lessons are not lost.",
  "Judul dokumen (mis. Proposal Ormawa Visit)": "Document title (e.g. Ormawa Visit Proposal)",
  "Judul tautan": "Link title",
  "Judul tautan wajib diisi.": "A link title is required.",
  "Nama A-Z": "Name A-Z",
  "Nama Z-A": "Name Z-A",
  "Ormawa Visit terbaru": "Newest Ormawa Visit",
  "Ormawa Visit terlama": "Oldest Ormawa Visit",
  "Otomatis tampil di Super Link dengan judul ini. Mengubah/menghapus tautan ini juga memperbarui Super Link.": "Shown in Super Link automatically under this title. Changing or removing the link updates Super Link too.",
  "Setiap tautan hasil wajib diberi judul.": "Every result link needs a title.",
  "Sudah dipakai": "Already used",
  "sumbernya sudah dihapus dari Super Link": "its source was deleted from Super Link",
  "Sumbernya sudah dihapus dari Super Link. Alamat terakhirnya tetap disimpan; pilih penggantinya bila ada.": "Its source was deleted from Super Link. The last address is kept; pick a replacement if there is one.",
  "tautan. Persempit pencarian untuk melihat sisanya.": "links. Narrow the search to see the rest.",
  "Tetap hapus": "Delete anyway",
  "tugas lain merujuk tautan ini. Menghapusnya juga menghapus entri Super Link-nya; tugas-tugas itu hanya menyimpan salinan alamatnya dan akan diberi tanda.": "other tasks reference this link. Removing it also deletes its Super Link entry; those tasks keep only a copy of the address and will be flagged.",
  "tugas lain. Perubahan alamat dan judul ikut terlihat di sana.": "other tasks. Changes to the address and title show up there too.",
  "Urutkan": "Sort",
};
