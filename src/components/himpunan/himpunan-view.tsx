...
import type { CompareEntry, FgdPlan, FgdRow, Prospect } from "@/lib/types";

export function HimpunanView({
  eventId, plans, rows, compare, accepted, canManage,
}: {
  eventId: string;
  plans: FgdPlan[];
  ...
  return (
    <Tabs defaultValue="fgd">
      ...
      <TabsContent value="compare">
        <ComparePanel eventId={eventId} entries={compare} accepted={accepted} canManage={canManage} />
      </TabsContent>
    </Tabs>
  );
}
