...
--   * Baris buatan tangan di aplikasi (source <> 'sheet') TIDAK disentuh.
...
create temporary table sheet_links (
  event_id text,
  section  text,
  division text,
  name     text,
...
insert into sheet_links (event_id, section, division, name, url, note) values
